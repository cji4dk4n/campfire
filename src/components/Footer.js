  ...
  return (
    <div className="footer-main-container">
      <div className="footer-container">
        <div className="footer-item-container"><img alt="" className="footer-item" src="https://cloudinary-a.akamaihd.net/bountysource/image/gravatar/d_noaoqqwxegvmulwus0un.png,c_pad,w_200,h_200,b_white/e803824368f807180a6eea40dd5df951" /></div>
        <div className="footer-item-container"><img alt="" className="footer-item" src="https://cdn-images-1.medium.com/max/1200/1*i3hzpSEiEEMTuWIYviYweQ.png" /></div>
        <div className="footer-item-container"><img alt="" className="footer-item" src="https://i.pinimg.com/originals/71/f0/a4/71f0a4c41735f951f9823725ee42cf8a.png" /></div>
